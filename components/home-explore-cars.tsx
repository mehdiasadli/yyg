...
export default function HomeExploreCars() {
  ...
  return (
    <section className='font-montserrat relative py-24 px-6 bg-gray-50/3'>
        ...
        >
          ...
          <div className='hidden md:flex items-center gap-4'>
            <div className='flex items-center gap-2'>
              <button
                onClick={scrollPrev}
                className='p-2 rounded-full border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200'
              >
            ...
            {cars.map((car, index) => (
              ...
              >
                <Link href={car.link} className='group h-full block'>
                  <div className='relative bg-white rounded-lg overflow-hidden border border-gray-50 hover:border-gray-200 transition-all duration-300 hover:shadow-sm h-full flex flex-col'>
                    {/* Car Image */}
                    <div className='relative h-48 bg-gray-50 overflow-hidden'>
                      ...
                      {/* Premium Badge */}
                      {car.premium && (
                        <div className='absolute top-3 right-3 px-2 py-1 bg-gray-900/90 backdrop-blur-sm text-white text-xs font-light rounded-full'>
                          Premium
                        </div>
                      )}
                      ...
                      {car.images.length > 1 && (
                        <div className='absolute bottom-3 left-3 px-2 py-1 bg-black/70 backdrop-blur-sm text-white text-xs font-light rounded-full'>
                    ...
                    <div className='p-5 flex-grow flex flex-col'>
                      <div className='mb-4'>
                        <div className='flex items-center justify-between mb-2'>
                          <h3 className='font-light text-gray-900 text-lg group-hover:text-gray-700 transition-colors duration-200'>
                            {car.name}
                          </h3>
                        ...
                        <p className='text-sm text-gray-500 font-light mb-3'>{car.category}</p>
                      ...
                      <div className='mt-auto'>
                        <div className='flex items-center justify-between mb-3'>
                          <div>
                            <p className='text-xs text-gray-400 font-light mb-1'>Starting from</p>
                          ...
                          <div className='text-right'>
                            <p className='text-xs text-gray-400 font-light'>{car.price.daily.km} km included</p>
                          </div>
                        </div>
                        ...
                        <div className='pt-3 border-t border-gray-50'>
                          <div className='flex items-center justify-between'>
                            <p className='text-xs text-gray-400 font-light'>
                              <span className='text-gray-600 font-light'>{car.contact.name}</span>
                            </p>
                            <div className='flex items-center gap-2'>
                              <div className='p-1.5 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors duration-200'>
                                <Phone size={10} />
                              </div>
                              <div className='p-1.5 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors duration-200'>
