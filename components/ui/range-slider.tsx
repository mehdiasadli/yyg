...
const PriceRangeSlider = React.forwardRef<HTMLDivElement, PriceRangeSliderProps>(
  ({ className, data, min = 0, max = 5000, step = 10, defaultValue = [1000, 4000], onValueChange }, ref) => {
    ...
    return (
      <div className={cn('w-full px-4', className)} ref={ref}>
        ...
        <div className='grid grid-cols-2 items-center gap-4 mt-4'>
          <div className='bg-card p-4 rounded-lg text-center border'>
            ...
            <p className='text-xl font-semibold text-card-foreground'>{formatCurrency(minVal)}</p>
          </div>
          <div className='bg-card p-4 rounded-lg text-center border'>
            <p className='text-sm text-muted-foreground'>Maximum</p>
            <p className='text-xl font-semibold text-card-foreground'>{formatCurrency(maxVal)}</p>
          </div>
        </div>
      </div>
    );
