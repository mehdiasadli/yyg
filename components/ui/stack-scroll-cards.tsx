...
const StickyCard = ({ cards, className, containerClassName, imageClassName }: StickyCard002Props) => {
...
interface StackScrollCardsProps {
  cards: CardData[];
  className?: string;
  containerClassName?: string;
  imageClassName?: string;
...
const StackScrollCards = ({ cards, className, containerClassName, imageClassName }: StackScrollCardsProps) => {
  return (
    <StickyCard
      cards={cards}
      className={className}
