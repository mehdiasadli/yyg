...
const AnimatedSections: React.FC<AnimatedSectionsProps> = ({ sections = defaultSections, className = '' }) => {
  ...
  return (
    <div ref={containerRef} className={`h-screen w-full overflow-hidden bg-black text-white uppercase font-sans relative ${className}`}>
