...
const getServiceData = (serviceId: string) => {
  const services = {
    'intensive-car-care': {
      ...
      email: 'info@intensivecar.com',
      website: 'www.intensivecar.com',
      ...
      description:
        "Intensive Car Care is Dubai Marina's premier automotive detailing center, specializing in paint correction, ceramic coatings, and comprehensive car care services. With over 8 years of experience and state-of-the-art equipment, we provide exceptional results that protect and enhance your vehicle's appearance.",
      services: [
        {
          name: 'Basic Wash & Wax',
