...
import { Mail, Lock, Eye, EyeOff, ArrowLeft, Car, Shield, Award, TrendingUp } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <div className='max-w-md mx-auto w-full'>
            ...
            <motion.div variants={itemVariants} className='mb-10'>
              ...
              <h1 className='text-3xl sm:text-4xl font-semibold text-slate-900 mb-3 tracking-tight'>Welcome back</h1>
              <p className='text-slate-600 font-normal leading-relaxed'>Sign in to your account to continue</p>
            </motion.div>
            ...
            <motion.form onSubmit={handleSubmit} className='space-y-5' variants={itemVariants}>
              <div className='space-y-2'>
                ...
                <div className='relative'>
                  ...
                  <Input
                    ...
                    className='pl-12 pr-4 py-6 bg-slate-50 border-slate-200 rounded-xl focus:border-primary focus:ring-2 focus:ring-primary/20 font-normal transition-all duration-200'
                    required
                  />
                </div>
              </div>
              ...
              <div className='space-y-2'>
                ...
                <div className='relative'>
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className='pl-12 pr-12 py-6 bg-slate-50 border-slate-200 rounded-xl focus:border-primary focus:ring-2 focus:ring-primary/20 font-normal transition-all duration-200'
                    required
                  />
                  <button
                    type='button'
              ...
              <div className='flex items-center justify-between text-sm'>
                <div className='flex items-center gap-2'>
                  <Checkbox
                    id='remember-me'
                    className='size-5 flex justify-center items-center border border-slate-300 rounded [&[data-checked],&[data-indeterminate]]:bg-primary [&[data-checked],&[data-indeterminate]]:text-white [&[data-checked],&[data-indeterminate]]:border-primary transition-all duration-200'
                  >
                    <CheckboxIndicator className='size-3.5' />
                  </Checkbox>
                  <label htmlFor='remember-me' className='text-slate-600 font-normal cursor-pointer'>
                    Remember me
                  </label>
                </div>
                <Link
              ...
              <Button
                type='submit'
                className='w-full py-6 bg-primary hover:bg-primary/90 text-white rounded-xl font-semibold shadow-lg shadow-primary/25 transition-all duration-200'
              >
                Sign In
              </Button>
            </motion.form>
        ...
        >
          ...
          <div className='relative z-10 max-w-lg'>
            ...
            >
              <h2 className='text-4xl font-semibold text-white mb-6 leading-tight'>Dubai's Premier Car Marketplace</h2>
              <p className='text-xl text-slate-300 font-normal mb-12 leading-relaxed'>
                Join thousands of users renting and listing premium vehicles with 0% commission
              </p>
